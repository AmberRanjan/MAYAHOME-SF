...
if (noOfApplicants.equalsIgnoreCase('1')) {
	...
	Mobile.verifyElementText(findTestObject('Object Repository/Tester01/IncomeAndCommitmentStep2/txt_Step2of3'), 'Step 2 of 3')
	
	
} else if (noOfApplicants.equalsIgnoreCase('2')) {

	Mobile.verifyElementText(findTestObject('Object Repository/Tester01/IncomeAndCommitmentStep2/txt_Step2of6'), 'Step 2 of 6')
...
Mobile.setText(findTestObject('Object Repository/Tester01/IncomeAndCommitmentStep2/input_OtherHirePurchase'), GlobalVariable.OtherHirePurchase1, 0)
...
Mobile.setText(findTestObject('Object Repository/Tester01/IncomeAndCommitmentStep2/input_OtherTermLoan'), GlobalVariable.OtherTermLoan1, 0)
...
Mobile.setText(findTestObject('Object Repository/Tester01/IncomeAndCommitmentStep2/input_OtherHousingLoan'), GlobalVariable.OtherHousingLoan1, 0)
...
Mobile.setText(findTestObject('Object Repository/Tester01/IncomeAndCommitmentStep2/input_OtherOverdraft'), GlobalVariable.OtherOverdraft1, 0)
...
Mobile.setText(findTestObject('Object Repository/Tester01/IncomeAndCommitmentStep2/input_CreditCard'), GlobalVariable.CreditCard1, 0)
...
Mobile.setText(findTestObject('Object Repository/Tester01/IncomeAndCommitmentStep2/input_NonBankCommitments'), GlobalVariable.NonBankCommitments1, 0)

Mobile.verifyElementText(findTestObject('Object Repository/Tester01/IncomeAndCommitmentStep2/txt_TotalMontlyCommitment'), GlobalVariable.TotalMonthlyCommitments1)
