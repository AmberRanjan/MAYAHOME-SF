...
if (propertyPurchsedFromDeveloper_EditCustomerDetails.equalsIgnoreCase('Yes')) {
	...
	if (propertyCompleted6MonthsAgo_EditCustomerDetails.equalsIgnoreCase('Yes')) {
		...
		WebUI.callTestCase(findTestCase('Tester01/Pages/PropertyDetailsPage1/ReusuableMethods/NonlistedProperties'), [:], FailureHandling.STOP_ON_FAILURE)
		
		WebUI.callTestCase(findTestCase('Tester01/Pages/PropertyDetailsPage2/PropertyDetailsPage2_NonListed'), [:], FailureHandling.STOP_ON_FAILURE)
		
		WebUI.callTestCase(findTestCase('Tester01/Pages/PropertyDetailsPage3/PropertyDetailsPage3_NonListed'), [:], FailureHandling.STOP_ON_FAILURE)
