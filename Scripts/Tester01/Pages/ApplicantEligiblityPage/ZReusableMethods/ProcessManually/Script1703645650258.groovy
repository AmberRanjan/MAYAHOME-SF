...
Mobile.tap(findTestObject('Object Repository/Tester01/ApplicationEligiblityPage/btn_Submit_ProcessManually'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Tester01/ApplicationEligiblityPage/txt_ProcessManuallyDes1'), 40, FailureHandling.OPTIONAL)

Mobile.waitForElementPresent(findTestObject('Object Repository/Tester01/ApplicationEligiblityPage/txt_ProcessManuallyDes2'), 30)
