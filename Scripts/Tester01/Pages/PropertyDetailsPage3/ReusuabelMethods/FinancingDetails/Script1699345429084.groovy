...
Mobile.verifyElementExist(findTestObject('Object Repository/Tester01/PropertyDetailsPage2/txt_EditFinancingDetails'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester01/PropertyDetailsPage3/txt_FinancingAmountValue'), FinancingAmountValue, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester01/PropertyDetailsPage3/txt_FinancingPeriodValue'), financingPeriod, FailureHandling.CONTINUE_ON_FAILURE)
