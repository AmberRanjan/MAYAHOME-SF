...
WebUI.callTestCase(findTestCase('Tester01/Pages/PropertyDetailsPage1/PropertyDetailsPage1'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Test Cases/Tester01/Pages/ApplicantEligiblityPage/BauSoftFailStage_EligiblityPage'), [:], FailureHandling.STOP_ON_FAILURE)

if (noOfApplicants.equalsIgnoreCase('1')) {
	
WebUI.callTestCase(findTestCase('Tester01/Pages/IncomeAndCommitmentDetails/IncomeAndCommitmentDetails_1Applicant'), [:], FailureHandling.STOP_ON_FAILURE)

}

else if (noOfApplicants.equalsIgnoreCase('2')) {
	
	WebUI.callTestCase(findTestCase('Tester01/Pages/IncomeAndCommitmentDetails/IncomeAndCommitmentDetails_2Applicants'), [:], FailureHandling.STOP_ON_FAILURE)
}

WebUI.callTestCase(findTestCase('Test Cases/Tester01/Pages/ApplicantEligiblityPage/BauSoftFailStage_SuccessPage'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Tester02_New/Pages/DataEntryPages/DataEntryPage2/DataEntryPage2_Validation_Full'), [:],
FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Tester02_New/Pages/DataEntryPages/DataEntryPage3/DataEntryPage3_Validation_Full'), [:],
FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Tester02_New/Pages/DataEntryPages/DataEntryPage4/DataEntryPage4_Validation_Full'), [:],
FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Tester02_New/Pages/DataEntryPages/ReviewPage/ReviewPage_Validation_Full'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Test Cases/Tester03/Pages/Manager Flow/Manager Flow_TwoApplicant_BAU_SoftFail_AddCCRIS_Full'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Test Cases/Tester01/Pages/AddToCCRIS/CasePage/UnSatisfactoryAIP_ProcessInWoloc_SoftFail'), [:], FailureHandling.STOP_ON_FAILURE)*/
