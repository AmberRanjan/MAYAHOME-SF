...
WebUI.callTestCase(findTestCase('Test Cases/Tester01/Pages/ApplicantEligiblityPage/BauSoftFailStage_EligiblityPage'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('Test Cases/Tester01/Pages/AddToCCRIS/CasePage/UnSatisfactoryAIP_ProcessInWoloc_SoftFail'), [:], FailureHandling.CONTINUE_ON_FAILURE)
