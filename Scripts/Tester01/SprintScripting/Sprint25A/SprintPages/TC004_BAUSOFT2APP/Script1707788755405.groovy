...
WebUI.callTestCase(findTestCase('Test Cases/Tester01/Pages/AddToCCRIS/ReusableMethods/PropertyInsuranceConfirmation'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Test Cases/Tester01/Pages/AddToCCRIS/CasePage/UnSatisfactoryAIP_SubmitToManager_SoftFail'), [:], FailureHandling.CONTINUE_ON_FAILURE)
