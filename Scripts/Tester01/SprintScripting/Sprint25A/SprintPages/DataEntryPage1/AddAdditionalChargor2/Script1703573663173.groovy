...
Mobile.verifyElementText(findTestObject('Object Repository/Tester01/DataEntry/input_Name'), GlobalVariable.ChargorName2, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyMatch(chargorNric1, GlobalVariable.ChargorNric2, true, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester01/DataEntry/input_AlternateIDType'), GlobalVariable.ChargorAlernateIDType2, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyMatch(chargorAlternateID, GlobalVariable.ChargorAlternativeIDNumber2, true, FailureHandling.CONTINUE_ON_FAILURE)
...
CustomKeywords.'com.keywords.DropDownValidation.drpDown_TextSearch'('Object Repository/Tester01/DataEntry/drpDown_Relationship', 'Please Select', GlobalVariable.RelationshipwithChargor2)
...
CustomKeywords.'com.keywords.DropDownValidation.drpDown_TextSearch'('Object Repository/Tester01/DataEntry/drpdown_ExisitingHome', 'Please Select', GlobalVariable.ExistingHomeFinancingChargor2)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Tester01/DataEntry/txt_ApplicantOnlyEligibliefor70Percent'), 30, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Object Repository/Tester01/DataEntry/txt_ApplicantOnlyEligibliefor70PercentDescription'), 30, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot(FailureHandling.OPTIONAL)

Mobile.tap(findTestObject('Object Repository/Tester01/DataEntry/btn_IUnderstand'), 30, FailureHandling.CONTINUE_ON_FAILURE)
