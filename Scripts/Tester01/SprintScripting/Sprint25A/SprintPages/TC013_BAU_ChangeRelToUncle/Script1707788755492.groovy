...
Mobile.verifyElementText(findTestObject('Tester01/ApplicationEligiblityPage/txt_BAU'), 'BAU')

WebUI.callTestCase(findTestCase('Test Cases/Tester01/Pages/ApplicantEligiblityPage/ZReusableMethods/ViewBauReasons'), [:], FailureHandling.CONTINUE_ON_FAILURE)
