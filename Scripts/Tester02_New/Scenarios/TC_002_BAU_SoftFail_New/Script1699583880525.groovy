...
Mobile.callTestCase(findTestCase('Tester02_New_New/Pages/Login/ReusableMethods_Login/Method_Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
//---------------------------------------------------BAU Soft Fail Screen script Required-------------------------------------------------------
