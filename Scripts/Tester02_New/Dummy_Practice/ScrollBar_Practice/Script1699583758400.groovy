...
/*
 //Mobile.swipe(100, 0, 0, 0)
 //Mobile.verifyElementVisible(findTestObject('Object Repository/Tester02_New/test scroll_Years/android.view.ViewGroup'), 0)
 //Mobile.tap(findTestObject(''), 0)
 //Mobile.verifyElementVisible(findTestObject('Object Repository/Tester02_New/test scroll_Years/android.view.ViewGroup (1)'), 0)
 Mobile.verifyElementVisible(findTestObject('Object Repository/Tester02_New/test scroll_Years/android.view.ViewGroup (2)'), 0)
 int n = Mobile.tapAndHold(findTestObject('Object Repository/Tester02_New/test scroll_Years/android.view.ViewGroup (2)'), 0, 0)
 Mobile.swipe(146, 1330, 280, 1330)
