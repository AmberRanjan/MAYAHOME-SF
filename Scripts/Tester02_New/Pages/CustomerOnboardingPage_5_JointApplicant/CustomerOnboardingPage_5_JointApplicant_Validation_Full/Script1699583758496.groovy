...
CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.PrimaryIncome_JointApplicant)
...
CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.PrimarySourceOfWealth_JointApplicant)
...
if(GlobalVariable.MoreThanOneProperty_JointApplicant == 'Yes') {
...
if(GlobalVariable.MoreThanOneProperty_JointApplicant == 'No') {
...
if(GlobalVariable.PendingApplicationsOnOtherBank_JointApplicant == 'Yes') {
...
if(GlobalVariable.PendingApplicationsOnOtherBank_JointApplicant == 'No') {
