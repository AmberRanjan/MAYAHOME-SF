...
Mobile.setText(findTestObject('Object Repository/Tester02_New/CustomerOnboardingPage_1/CustomerOnboardingPage1_textBox_Name'),GlobalVariable.CustomerName_MainApplicant,
		0)
...
CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.Alternative_IDType)
...
Mobile.setText(findTestObject('Object Repository/Tester02_New/CustomerOnboardingPage_1/CustomerOnboardingPage1_textBox_Alternate ID Number'),
		GlobalVariable.Alternative_IDNumber, 0)
...
CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.CustomerGroup)
...
CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.Religion)
...
if(GlobalVariable.Salutation == 'Ms/ Cik')
{
	...
	Mobile.tap(findTestObject('Object Repository/Tester02_New/CustomerOnboardingPage_1/CustomerOnboardingPage1_dropdownArrow_Alternate ID Type (Optional)_Search_Result',[('Variable') : GlobalVariable.Salutation]),
	0)
}else {
	CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.Salutation)
}
...
CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.Gender)
...
CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.Education)
...
CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.MaritalStatus)
...
Mobile.setText(findTestObject('Object Repository/Tester02_New/CustomerOnboardingPage_1/CustomerOnboardingPage1_textbox_Phone Number'),GlobalVariable.PhoneNumber,0)
...
CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.Resident_Status)
...
CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.Employment_Status)
...
if(GlobalVariable.Business_Type == 'MNC / Public Listed')
{
	...
	Mobile.tap(findTestObject('Object Repository/Tester02_New/CustomerOnboardingPage_1/CustomerOnboardingPage1_dropdownArrow_Alternate ID Type (Optional)_Search_Result',[('Variable') : GlobalVariable.Business_Type]),
	0)

}else {
	CustomKeywords.'methods_Tester02.dropdown_Search.dropDown_Search'(GlobalVariable.Business_Type)
}
