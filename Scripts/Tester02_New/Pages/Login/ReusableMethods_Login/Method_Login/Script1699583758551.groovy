...
if (userIsOnLoginPage == true) {
    ...
    Mobile.setText(findTestObject('Tester02_New/LoginPage/LoginPage_textBox_PF Number'), GlobalVariable.SF_Agent_PF_ID, 0)
	
	Mobile.delay(3)

    Mobile.setText(findTestObject('Tester02_New/LoginPage/LoginPage_textBox_Password'), GlobalVariable.SF_Agent_Password, 0)
