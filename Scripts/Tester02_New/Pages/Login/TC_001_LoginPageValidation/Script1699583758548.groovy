...
'DataFile'
GlobalVariable.SF_ApplicationID = findTestData(sheet).getValue('Application_ID', Row_Number)
GlobalVariable.SF_Agent_PF_ID = findTestData(sheet).getValue('PF_ID', Row_Number)
GlobalVariable.SF_Agent_Password = findTestData(sheet).getValue('Password', Row_Number)
 */
...
Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Tester02_New/LoginPage/LoginPage_button_Login'), 'clickable', 'false',
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester02_New/LoginPage/LoginPage_text_PF Number does not exist'), '[SF02] PF Number does not exist and/or is inactive. Please refer to Sales Force Helpdesk for more information',
		FailureHandling.CONTINUE_ON_FAILURE)
/*
...
Mobile.setText(findTestObject('Tester02_New/LoginPage/LoginPage_textBox_PF Number'), GlobalVariable.SF_Agent_PF_ID, 10, FailureHandling.CONTINUE_ON_FAILURE)

//Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Tester02_New/LoginPage/LoginPage_button_Login'), 'clickable', 'true',10, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/Tester02_New/LoginPage/LoginPage_button_Login'), 10, FailureHandling.CONTINUE_ON_FAILURE)

Boolean UserIsOnHomePage = Mobile.verifyElementVisible(findTestObject('Object Repository/Tester02_New/HomePage/HomePage_text_Mortgage'), 10,
		FailureHandling.OPTIONAL)
	...
	if (userIsLoginFirstTimeScreen == true) {
		...
		if (UserIsOnFirstTimeLoginMobileNumberPage == true) {
			...
			Mobile.verifyElementText(findTestObject('Object Repository/Tester02_New/FirstTimeLoginPage/FirstTimeLoginPage_MobileNumber_text_Please enter a valid phone number in order to proceed. Eg 0122228262'),
					'Please enter a valid phone number in order to proceed. Eg 0122228262', FailureHandling.CONTINUE_ON_FAILURE)
