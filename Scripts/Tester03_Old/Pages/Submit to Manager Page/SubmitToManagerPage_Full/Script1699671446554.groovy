...
Mobile.verifyEqual(Mobile.getText(findTestObject('Object Repository/Tester03_old/Submit to Manager Page/CaseProcessingPage_text_Please ensure_BAU'), 
        0), 'Please ensure all the documents are correct and complete before submitting to the manager.')
...
Mobile.tap(findTestObject('Object Repository/Tester03_old/Submit to Manager Page/CaseProcessingPage_ClickableImage_Data Entry'), 
    0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Tester03_old/Submit to Manager Page/DataEntryReviewPage_Title_Data Entry Review'), 
    0)
...
Mobile.callTestCase(findTestCase('Tester03_Old/Pages/LOTermsAndConditionsPage/LOTermsAndConditionPage_Full'), [:], FailureHandling.STOP_ON_FAILURE)
