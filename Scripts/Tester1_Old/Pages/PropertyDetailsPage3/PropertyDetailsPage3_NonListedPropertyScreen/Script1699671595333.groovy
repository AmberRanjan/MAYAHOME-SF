...
Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_ApplicantEligiblity1'), 
    'Please fill up the following details to check')

Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_ApplicantEligiblity2'), 
    'your applicant\'s eligibility')

//verify Property detail text
Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_PropertyDetails'), 
    'Property Details')
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_PropertyAddress'), 
    'Property Address')

Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_PropertyAddressvalue'), 
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_DevelopmentTypeValue'), 'Apartment')
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_PropertyAreaValue'), 'Prime')
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_LeaseTypeValue'), 'Freehold')

//verify property price details are displayed as entered in previous screen
Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_PropertyPrice'), 
    'Property Price')

Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_PropertyPriceValue'),
	'RM 300,000.00')
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage3/txt_FinancingAmountValue'), 'RM 250,000.00')
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage3/txt_FinancingPeriodValue'), '5 Years')

//validate financing plan details
Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage3/txt_FinancingDetails'), 'Financing Details')

CustomKeywords.'com.keywrods.ScrollAction.scroll'(0.60, 0.30)
