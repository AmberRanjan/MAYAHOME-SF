...
Mobile.setText(findTestObject('Tester1_old/PropertyDetailsPage2/input_FinancingAmountValue'), GlobalVariable.FinancingAmountValue, 
    0)
...
//Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage3/txt_FinancingPeriod'), GlobalVariable.FinancingPeriodYears)
Mobile.takeScreenshot(FailureHandling.OPTIONAL)

CustomKeywords.'com.keywrods.ScrollAction.scroll'(0.30, 0.70)

//Mobile.verifyElementText(findTestObject('Object Repository/Tester1_old/PropertyDetailsPage2/txt_FinancingPeriodYears'), GlobalVariable.FinancingPeriodYears)
