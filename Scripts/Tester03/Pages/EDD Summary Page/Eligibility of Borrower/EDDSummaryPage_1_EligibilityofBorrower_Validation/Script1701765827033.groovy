...
//Mobile.verifyEqual(Mobile.getText(findTestObject('Object Repository/Tester03_old/DataEntryCompletedEDDSummaryPage/DataEntryCompleted_text_You can now'), 
  //      0), 'You can now perform Educate Discipline Decision and complete the EDD Summary.')
...
'Checking Eligibility of Borrower Current Status: AMBER or RED'
...
if (Mobile.verifyElementExist(findTestObject('Object Repository/Tester03_old/EDD Summary Page 1/EDDSummaryPage_Dynamicbutton_Mitigate', 
        [('Verify') : 'Eligibility of Borrower']), 15, FailureHandling.OPTIONAL)) {
