...
Mobile.verifyEqual(Mobile.getText(findTestObject('Object Repository/Tester03/EDD Summary Page 1/EDDSummaryPage_field_Credit Policies'),
		0), 'Credit Policies')

Mobile.takeScreenshot()

CreditPolicies = Mobile.getText(findTestObject('Object Repository/Tester03/EDD Summary Page 1/EDDSummaryPage_field_Credit Policies'), 0)
...
//
//Mobile.tap(findTestObject('Object Repository/Tester03/EDD Summary Page 2/EDDSummaryPage_text_AMBER', [('Verify') : 'Credit Policies']),
//	0)
//
//Mobile.takeScreenshot()
//
...
'Checking if Credit Policies Current Status: AMBER or RED'
...
if (Mobile.verifyElementExist(findTestObject('Object Repository/Tester03_old/EDD Summary Page 1/EDDSummaryPage_Dynamicbutton_Mitigate',
	[('Verify') : 'Credit Policies']), 15, FailureHandling.OPTIONAL)) {
...
Mobile.callTestCase(findTestCase('Test Cases/Tester03/Pages/EDD Summary Page/Credit Policies/EDDSummaryPage_2_CreditPolicies_Validation'), ['CreditPolicies':CreditPolicies], FailureHandling.STOP_ON_FAILURE)
}
