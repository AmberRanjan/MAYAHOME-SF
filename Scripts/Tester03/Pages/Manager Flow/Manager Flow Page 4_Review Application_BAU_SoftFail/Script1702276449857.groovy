...
//Mobile.verifyElementText(Mobile.getText(findTestObject('Object Repository/Tester03/Manager Flow/Review Application Page/ReviewApplicationPage_text_Please ensure you verify'), 
...
Mobile.callTestCase(findTestCase('Test Cases/Tester03/Pages/Manager Flow/Manager Flow Page 5_Data Entry_BAU_SoftfFail_TwoApplicants'), [:], FailureHandling.CONTINUE_ON_FAILURE)


Mobile.waitForElementPresent(findTestObject('Object Repository/Tester03/Manager Flow/Review Application Page/ReviewApplicationPage_Title_Review Application'), 10)

EDDSummary_Status = Mobile.getText(findTestObject('Object Repository/Tester03/Manager Flow/Review Application Page/ReviewApplicationPage_text_EDDSummary_Status'), 0)

'Second Review Option'
Mobile.tap(findTestObject('Object Repository/Tester03/Manager Flow/Review Application Page/ReviewApplicationPage_EDDSummary_Icon_RightArrow'),  0)
