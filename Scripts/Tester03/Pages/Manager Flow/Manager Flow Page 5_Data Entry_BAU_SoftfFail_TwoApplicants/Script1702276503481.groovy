...
/*Mobile.tap(findTestObject('Object Repository/Tester03/Manager Flow/Data Entry Page_BAU Pass/DataEntryPage_button_Mark as Verified'), 30)
...
Mobile.verifyElementText(findTestObject('Object Repository/Tester03/Manager Flow/Data Entry Page_BAU Pass/DataEntryPage_TitleText_Data Entry'), 'Data Entry')

Mobile.tap(findTestObject('Object Repository/Tester03/Manager Flow/Review Application Page/ReviewApplicationPage_Arrow_Data Entry'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Tester03/Manager Flow/Data Entry Page_BAU Pass/DataEntryPage_TitleText_Data Entry'), 30, FailureHandling.CONTINUE_ON_FAILURE)
...
if (Mobile.verifyElementExist(findTestObject('Object Repository/Tester03/Manager Flow/Data Entry Page_STP/DataEntryPage_text_Is this applicant a Maybank'),
	...
	Mobile.callTestCase(findTestCase('Test Cases/Tester03/Pages/Manager Flow/Manager Flow Page 5_Data Entry_BAU_SoftFail'), [:], FailureHandling.STOP_ON_FAILURE)
} else {
